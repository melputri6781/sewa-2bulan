                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            this.reply(id, text, false, { mentions: [user] })
                        }
                    }
                }
                break
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        group: '*ɢʀᴏᴜᴘ ᴏɴʟʏ •* ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴅᴀᴘᴀᴛ ᴅɪɢᴜɴᴀᴋᴀɴ ᴅɪ ɢʀᴏᴜᴘ !!',
         vip: '🔒 *PERINTAH INI HANYA UNTUK MEMBER VIP KAK*.',
